                ...
                <div className="grid max-w-screen-xl grid-cols-1 gap-10 pt-10 mx-auto mt-5 border-t border-gray-100 dark:border-trueGray-700 lg:grid-cols-5">
                    <div className="lg:col-span-2">
                        ...
                        <div className="max-w-md mt-4 text-gray-500 dark:text-gray-400">
                            I am a creative Designer and Developer. I love to design and code beautiful things, and I believe that good design must serve a purpose.
                        </div>

                        <div className="mt-5">
                            <Link  href="/">
                                <a className="flex items-center space-x-2 text-2xl font-medium text-gray-600 dark:text-gray-100">
